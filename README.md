...
- [docs/console-parity.md](docs/console-parity.md) — what the local console must match, and what could not be evidenced
- [docs/console-verification.md](docs/console-verification.md) — the parity checklist walked on a fresh stack, and what it found
