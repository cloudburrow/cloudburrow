...
func NewServer() (*Server, error) {
	...
	// Modified by CloudBurrow: the fault-injection server and interceptor
	// are removed. Their faultpb package is generated by Bazel and not
	// committed upstream, and the oracle injects no faults.
	s := grpc.NewServer(grpc.ChainUnaryInterceptor(newLockInterceptor(&fakeKMS.mux)))
