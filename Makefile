...
## It is a Bazel C++ build: expect roughly 25 minutes on first use, once.
## Deliberately not part of `make build` — nobody should pay that cost unless
## they are going to use local AI.
litert-lm:
